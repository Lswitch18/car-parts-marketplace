...
BEGIN
  ...
  END IF;
  -- Resolve category IDs dynamically
  SELECT id INTO cat_engine   FROM categories WHERE slug = 'engine';
  SELECT id INTO cat_turbo    FROM categories WHERE slug = 'turbo-boost';
  SELECT id INTO cat_exhaust  FROM categories WHERE slug = 'exhaust';
  SELECT id INTO cat_brakes   FROM categories WHERE slug = 'brakes';
  SELECT id INTO cat_susp     FROM categories WHERE slug = 'suspension';
  SELECT id INTO cat_wheels   FROM categories WHERE slug = 'wheels';
  SELECT id INTO cat_trans    FROM categories WHERE slug = 'transmission';
  SELECT id INTO cat_bodykit  FROM categories WHERE slug = 'body-kits';
  ...
  SELECT id INTO cat_light    FROM categories WHERE slug = 'lighting';
  SELECT id INTO cat_cool     FROM categories WHERE slug = 'cooling';
  SELECT id INTO cat_fuel     FROM categories WHERE slug = 'fuel';
  SELECT id INTO cat_wing     FROM categories WHERE slug = 'wings-spoilers';
  SELECT id INTO cat_fluids   FROM categories WHERE slug = 'fluids';
  SELECT id INTO cat_filters  FROM categories WHERE slug = 'filters';
  SELECT id INTO cat_clutch   FROM categories WHERE slug = 'clutch';
  SELECT id INTO cat_ic       FROM categories WHERE slug = 'intercooler';
  SELECT id INTO cat_steer    FROM categories WHERE slug = 'steering';
  SELECT id INTO cat_body     FROM categories WHERE slug = 'bodywork';
  ...
  (
    ...
    ARRAY['https://clqubcryhbrjlupkgeva.supabase.co/storage/v1/object/public/parts-images/engine-2jzgte.png'],
  ...
  (
    ...
    ARRAY['https://clqubcryhbrjlupkgeva.supabase.co/storage/v1/object/public/parts-images/engine-rb26dett.png'],
  ...
  (
    ...
    ARRAY['https://clqubcryhbrjlupkgeva.supabase.co/storage/v1/object/public/parts-images/exhaust-hks-hipower.png'],
    'active', seller_id, 2024, 'Fuji, JP',
  ...
  (
    ...
    68000, 'good', fujitsubo_id, cat_exhaust,
    ARRAY['https://clqubcryhbrjlupkgeva.supabase.co/storage/v1/object/public/parts-images/exhaust-hks-hipower.png'],
  ...
  (
    ...
    320000, 'good', rays_id, cat_wheels,
    ARRAY['https://clqubcryhbrjlupkgeva.supabase.co/storage/v1/object/public/parts-images/wheels-work-meister.png'],
    'active', seller_id, 2024, 'Osaka, JP',
  ...
  (
    ...
    240000, 'good', work_id, cat_wheels,
    ARRAY['https://clqubcryhbrjlupkgeva.supabase.co/storage/v1/object/public/parts-images/wheels-work-meister.png'],
    'active', seller_id, 2024, 'Osaka, JP',
  ...
  (
    ...
    ARRAY['https://clqubcryhbrjlupkgeva.supabase.co/storage/v1/object/public/parts-images/bodykit-veilside-rx7.png'],

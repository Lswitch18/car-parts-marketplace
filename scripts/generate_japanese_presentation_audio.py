...
SLIDES_JA = [
    {
        "id": 1,
        "text": "DAIG公式プレゼンテーションへようこそ。DAIGは、日本初となるマルチモーダルAIを搭載した次世代JDM自動車パーツプラットフォームです。出品画面では、高度なコンピュータビジョンアシスタントにより、技術仕様や型番の手動入力を完全にゼロにします。"
    },
    {
        "id": 2,
    ...
    {
        "id": 4,
        "text": "DAIGの最大の強みの一つは、リアルタイム多言語ローカライズです。言語セレクターをワンクリックするだけで、日本のカタカナや漢字のパーツ情報が自然なポルトガル語へと瞬時に翻訳されます。世界中のバイヤーやチューニングショップが、言葉の壁なく希少なパーツを見つけることができます。"
    },
    {
        "id": 5,
        "text": "マーケットプレイスの管理画面では、日本円でのリアルタイムな資金フローを確認できます。DAIGはStripe Connectによる安全なエスクロー信託を採用しており、プラットフォームが10%の手数料を保持し、残り90%をセラーへ自動送金することで、不正を防ぎ安全な取引を実現します。"
    },
    {
        "id": 6,
        "text": "法人エコシステムを強化するため、DAIGは自動車解体業者やパートナー店舗向けに包括的なB2B SaaSハブを提供しています。月次経常収益MRR、Starter・Pro・Enterpriseプランの契約状況、回収率100%のStripe Billing連携を一元管理。日本市場をリードする高バリュエーション設計です。"
    }
]

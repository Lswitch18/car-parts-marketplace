...
## Corpus Check
- 354 files · ~819,324 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1705 nodes · 2535 edges · 199 communities (145 shown, 54 thin omitted)
...
### Community 11 - "axios"
Cohesion: 0.10
Nodes (15): TabType, ChatPopup(), ChatPopupProps, Conversation, Message, iconMap, Props, SafeImage() (+7 more)
...
### Community 22 - "Ne"
Cohesion: 0.11
Nodes (10): AdminDashboard(), TransactionManagement(), PREDEFINED_PERMISSIONS, UserManagement(), getIdentityPulse(), getPartsPulse(), loadGsiScript(), signInWithGoogle() (+2 more)
...
Cohesion: 0.12
Nodes (21): AdminLayout(), Dashboard(), TenantDashboard(), ContactsManagement(), OnboardingGuard(), ProtectedRoute(), AuthState, createMinimalUser() (+13 more)

### Community 89 - "J"
Cohesion: 0.10
Nodes (23): Onboarding(), STORE_TYPES, Subscription(), PartDetailDrawer(), Props, PartsLookupHeader(), Props, Props (+15 more)
...
Cohesion: 0.06
Nodes (28): FitmentBadge(), Props, Props, ProductUI, CreateWorkOrderInput, TenantCoreService, TenantInventoryStats, AuctionBid (+20 more)
...
## Knowledge Gaps
- **687 isolated node(s):** `build-apk.sh script`, `ANDROID_HOME`, `PATH`, `build-store-apk.sh script`, `ANDROID_HOME` (+682 more)
...
- **Why does `useI18n()` connect `J` to `vendor-react-DqCMjyrC.js`, `vendor-react-DqCMjyrC.js`, `i`, `axios`, `.copy`, `t`, `index-B_no5lKC.js`, `useTranslation`, `Ne`, `EtiquetasPage.tsx`, `useAuthStore`, `.push`?**

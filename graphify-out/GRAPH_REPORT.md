...
## Corpus Check
- 366 files · ~864,108 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1745 nodes · 2612 edges · 201 communities (144 shown, 57 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3dfcf263`
...
### Community 22 - "Ne"
Cohesion: 0.11
Nodes (6): TransactionManagement(), MapaPage(), WMSPage(), loadGsiScript(), signInWithGoogle(), updateTransactionStatus()
...
Cohesion: 0.17
Nodes (8): logisticsApi, DropoffPage(), TransportesPage(), ETAPAS, TIPO_LABEL, TrackingPublico(), mockFetch, AgenciaPage()
...
Cohesion: 0.12
Nodes (12): iconMap, Props, PartDetailDrawer(), Props, Props, VehicleSelector(), PartsLookup(), PARTNER_PLANS (+4 more)
...
Cohesion: 0.10
Nodes (22): AdminLayout(), JapanBankAccount(), ContactsManagement(), OnboardingGuard(), ProtectedRoute(), Subscription(), AuthState, createMinimalUser() (+14 more)

### Community 89 - "J"
Cohesion: 0.09
Nodes (24): DeliveriesManagement(), DeliveryTransaction, PREDEFINED_PERMISSIONS, UserManagement(), PLAN_DETAILS, SaasCompanySubscription, SaasControlCenter(), STORE_TYPE_CONFIG (+16 more)
...
Cohesion: 0.18
Nodes (11): clsx, jsbarcode, leaflet, lucide-react, dependencies, clsx, jsbarcode, leaflet (+3 more)
...
## Knowledge Gaps
- **702 isolated node(s):** `build-apk.sh script`, `ANDROID_HOME`, `PATH`, `build-store-apk.sh script`, `ANDROID_HOME` (+697 more)
...
- **Why does `dependencies` connect `dependencies` to `react-dom`, `react-is`, `react-leaflet`, `@react-three/fiber`, `shadcn`, `@tanstack/react-query`, `three`, `.copy`, `@supabase/supabase-js`, `Wt`, `B`, `Catalog-Dz-L_iSM.js`, `.clone`, `l`, `l`, `.setAttribute`, `.toString`, `Ye`, `index-BjaIWHBv.js`, `ln`, `.applyMatrix4`, `B`, `xn`, `Catalog-Dz-L_iSM.js`, `@base-ui/react`, `NotificationCenter.tsx`, `@capacitor/core`, `@base-ui/react`, `package.json`, `qrcode`?**

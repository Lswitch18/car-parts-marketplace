# Graph Report - car-parts-marketplce  (2026-08-06)

## Corpus Check
- 382 files · ~1,078,194 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1644 nodes · 2687 edges · 196 communities (129 shown, 67 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca7add59`
...
Cohesion: 0.10
Nodes (24): AdminLayout(), JAPAN_BANKS, JapanBankForm(), DeliveriesManagement(), JapanBankAccount(), ContactsManagement(), OnboardingGuard(), SaasGatewayPage() (+16 more)

### Community 7 - "n"
Cohesion: 0.06
Nodes (36): SaasHeroSection(), AiPartQuickUploadModal(), AiPartQuickUploadModalProps, LegalFinanceCenter(), InterchangeMapping, PartInterchangeManager(), PartInterchangeManagerProps, VehicleStrippingYieldModal() (+28 more)
...
### Community 12 - ".copy"
Cohesion: 0.17
Nodes (5): DeliveryTransaction, TransactionManagement(), updateTransactionStatus(), PARTNER_PLANS, PartnerPlan

### Community 13 - "r"
Cohesion: 0.07
Nodes (17): SearchResult, TYPE_LABELS, NotificationCenter(), timeAgo(), DEFAULT_ICON, STATUS_COLOR, STATUS_ENTREGA, DONUT_COLORS (+9 more)
...
Cohesion: 0.12
Nodes (17): auto-parts-db, autoprefixer, @capacitor/cli, devDependencies, auto-parts-db, autoprefixer, @capacitor/cli, @testing-library/dom (+9 more)

### Community 24 - "PartCard.tsx"
Cohesion: 0.31
Nodes (5): corsHeaders(), json(), redisCmd(), redisGet(), supabase
...
### Community 26 - "Wt"
Cohesion: 0.08
Nodes (27): AgenciaPage, DriverApp(), Login, MobileApp, QRInstallPage, WorkerApp, queryClient, root (+19 more)

### Community 27 - ".getSize"
Cohesion: 0.11
Nodes (13): logisticsApi, getWarehouseLocation(), LabelCard(), LEVEL_COLORS, emptyForm, PedidoForm, STATUS_COLOR, STATUS_OPTIONS (+5 more)
...
Cohesion: 0.18
Nodes (11): axios, @capacitor/ios, dependencies, axios, @capacitor/ios, react-dom, react-is, @types/leaflet (+3 more)
...
### Community 46 - "ln"
Cohesion: 0.06
Nodes (36): ChatPopup(), ChatPopupProps, Conversation, Message, Conversation, Message, Messages(), Terceiro (+28 more)
...
Cohesion: 0.10
Nodes (9): PREDEFINED_PERMISSIONS, UserManagement(), authFetch(), ColetasPage(), DropoffPage(), MapaPage(), loadGsiScript(), signInWithGoogle() (+1 more)
...
### Community 113 - "cn"
Cohesion: 0.29
Nodes (4): AuditLogEvent, DEMO_AUDIT_LOGS, SecurityAuditCenter(), I18nProvider()
...
Cohesion: 0.28
Nodes (6): App(), Props, ProtectedRoute(), Onboarding(), STORE_TYPES, isSaaSUser()

## Knowledge Gaps
- **553 isolated node(s):** `CustomIconProps`, `build-apk.sh script`, `ANDROID_HOME`, `PATH`, `build-store-apk.sh script` (+548 more)
...
- **Why does `dependencies` connect `WMSPage.tsx` to `ws`, `zustand`, `GlobalSearch.tsx`, `index-B_no5lKC.js`, `vite.config.js`, `NotificationCenter.tsx`, `class-variance-authority`, `gsap`, `@gsap/react`, `lenis`, `typescript-eslint`, `react`, `@capacitor/android`, `react-router`, `@southdevs/capacitor-google-auth`, `PedidoDetail.tsx`, `leaflet`, `@capacitor/core`, `@codetrix-studio/capacitor-google-auth`, `@fontsource-variable/geist`, `framer-motion`, `jsbarcode`, `WorkerApp-BWctDf0A.js`, `lucide-react`, `react-leaflet`, `@react-three/drei`, `recharts`, `shadcn`, `@supabase/supabase-js`, `tailwind-merge`, `tailwindcss`, `@tanstack/react-query`, `three`, `tw-animate-css`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `useI18n()` connect `n` to `LogistixDashboard-ZhczRoYg.js`, `@capacitor/android`, `.setAttribute`, `.clone`, `.toString`, `.copy`, `Ye`, `ln`, `r`, `r`, `cn`, `.push`, `@supabase/supabase-js`, `Ne`, `B2BPage.tsx`, `ProtectedRoute.tsx`, `.getSize`, `PedidosPage.tsx`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `qrcode` connect `leaflet` to `.getSize`, `WMSPage.tsx`?**

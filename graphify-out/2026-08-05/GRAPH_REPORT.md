# Graph Report - car-parts-marketplce  (2026-08-05)

## Corpus Check
- 407 files · ~1,083,612 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1693 nodes · 2689 edges · 225 communities (153 shown, 72 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ac6c34b2`
...
- insert_100yen_product.mjs
- remove_saas_permission.mjs
- setup_driver_and_packages.mjs
- test_purchase_flow.mjs
- test_seller_payout.mjs
- adminApi.test.ts
- EntregasPage.tsx
- canvas-confetti
- @eslint/js
...
## Communities (225 total, 72 thin omitted)

### Community 0 - "LogistixDashboard-ZhczRoYg.js"
Cohesion: 0.06
Nodes (34): AuthState, getTenantRolePermissions(), hasTenantPermission(), PedidoDetail(), FitmentBadge(), Props, Props, ProductUI (+26 more)

### Community 1 - "LogistixDashboard-ZhczRoYg.js"
Cohesion: 0.14
Nodes (13): Terceiro, TerceirosPage(), calculateFees(), FeeBreakdown, formatBRL(), formatJPY(), ConnectPayoutResult, StripeConnectAccountInfo (+5 more)
...
Cohesion: 0.10
Nodes (24): AdminLayout(), JAPAN_BANKS, JapanBankForm(), Dashboard(), TabType, JapanBankAccount(), ContactsManagement(), OnboardingGuard() (+16 more)

### Community 7 - "n"
Cohesion: 0.06
Nodes (35): SaasHeroSection(), AiPartQuickUploadModal(), AiPartQuickUploadModalProps, LegalFinanceCenter(), InterchangeMapping, PartInterchangeManager(), PartInterchangeManagerProps, VehicleStrippingYieldModal() (+27 more)
...
### Community 14 - "t"
Cohesion: 0.15
Nodes (26): callLogistixSync(), confirmPayment(), constantTimeCompare(), corsHeaders, errorResponse(), getWebhookSecret(), handleAsyncPaymentFailed(), handleChargeRefunded() (+18 more)
...
### Community 16 - "r"
Cohesion: 0.10
Nodes (19): AuctionItem, Auctions(), CONDITION_COLORS, RecentBid, SafeImage(), SafeImageProps, Part, Props (+11 more)
...
Cohesion: 0.13
Nodes (15): auto-parts-db, autoprefixer, eslint, devDependencies, auto-parts-db, autoprefixer, eslint, postcss (+7 more)

### Community 24 - "PartCard.tsx"
Cohesion: 0.09
Nodes (8): TransactionManagement(), PREDEFINED_PERMISSIONS, UserManagement(), MapaPage(), WMSPage(), loadGsiScript(), signInWithGoogle(), updateTransactionStatus()
...
Cohesion: 0.29
Nodes (6): name, overrides, @babel/core, private, type, version

### Community 36 - "WMSPage.tsx"
Cohesion: 0.18
Nodes (11): axios, canvas-confetti, dependencies, axios, canvas-confetti, react, react-is, @types/leaflet (+3 more)
...
### Community 46 - "ln"
Cohesion: 0.22
Nodes (8): QRStickerPrint(), QRStickerPrintProps, TabType, WorkOrder, RealNfeInvoice, RealTransactionSale, RealWorkOrder, useTenantRealData()
...
Cohesion: 0.13
Nodes (8): DeliveriesManagement(), DeliveryTransaction, PLAN_DETAILS, SaasCompanySubscription, SaasControlCenter(), STORE_TYPE_CONFIG, Onboarding(), STORE_TYPES

### Community 55 - "B2BPage.tsx"
Cohesion: 0.29
Nodes (9): __dirname, downloadObject(), headers, listBuckets(), listObjects(), ROOT, snapshot(), SNAPSHOT_DIR (+1 more)
...
Cohesion: 0.29
Nodes (7): __dirname, dumpTable(), now, ROOT, snapshot(), SNAPSHOT_DIR, supabase

### Community 113 - "cn"
Cohesion: 0.50
Nodes (4): EtiquetasPage(), getWarehouseLocation(), LabelCard(), LEVEL_COLORS

### Community 115 - "react-is"
Cohesion: 0.40
Nodes (3): STATUS_COLOR, TIPO_COLOR, TIPO_ICON

### Community 119 - "@react-three/fiber"
Cohesion: 0.33
...
### Community 146 - "GlobalSearch.tsx"
Cohesion: 0.38
...
### Community 180 - "typescript-eslint"
Cohesion: 0.33
Nodes (4): __dirname, partData, ROOT, supabase

### Community 181 - "PartCard.tsx"
Cohesion: 0.50
...
### Community 183 - "B2BPage.tsx"
Cohesion: 0.33
Nodes (4): ApiKey, LegalContract, RequestLog, WebhookItem

### Community 184 - "ChatPopup.tsx"
Cohesion: 0.40
...
### Community 189 - "eslint"
Cohesion: 0.40
Nodes (3): __dirname, i18nContent, ROOT

### Community 190 - "supabase"
Cohesion: 0.50
Nodes (4): __dirname, main(), ROOT, runSQL()

### Community 191 - "main.tsx"
Cohesion: 0.50
Nodes (3): queryClient, root, StoreApp()

## Knowledge Gaps
- **563 isolated node(s):** `CustomIconProps`, `build-apk.sh script`, `ANDROID_HOME`, `PATH`, `build-store-apk.sh script` (+558 more)
...
- **Why does `dependencies` connect `WMSPage.tsx` to `ws`, `zustand`, `index-B_no5lKC.js`, `GaidLogo.tsx`, `NotificationCenter.tsx`, `class-variance-authority`, `gsap`, `@gsap/react`, `lenis`, `@capacitor/android`, `leaflet`, `@base-ui/react`, `@capacitor/core`, `@capacitor/ios`, `clsx`, `@codetrix-studio/capacitor-google-auth`, `@fontsource-variable/geist`, `framer-motion`, `html5-qrcode`, `jsbarcode`, `WorkerApp-BWctDf0A.js`, `lucide-react`, `index.ts`, `react-leaflet`, `react-router-dom`, `@react-three/drei`, `recharts`, `shadcn`, `@supabase/supabase-js`, `tailwind-merge`, `tailwindcss`, `@tanstack/react-query`, `three`, `tw-animate-css`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `qrcode` connect `leaflet` to `cn`, `WMSPage.tsx`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `LabelCard()` connect `cn` to `leaflet`, `n`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._

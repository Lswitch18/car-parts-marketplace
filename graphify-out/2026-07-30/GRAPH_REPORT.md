...
## Corpus Check
- 366 files · ~959,464 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1747 nodes · 2614 edges · 206 communities (150 shown, 56 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3fe0086c`
...
### Community 22 - "Ne"
Cohesion: 0.11
Nodes (6): TransactionManagement(), Onboarding(), STORE_TYPES, loadGsiScript(), signInWithGoogle(), updateTransactionStatus()
...
### Community 37 - "B"
Cohesion: 0.30
Nodes (9): CreateListing(), BRAND_UUIDS, BRANDS, CATEGORIES, CATEGORY_UUIDS, CONDITIONS, MODEL_UUIDS, UUID_TO_BRAND (+1 more)
...
### Community 68 - "manufacturerApi.ts"
Cohesion: 0.40
...
### Community 72 - "Home.tsx"
Cohesion: 0.50
Nodes (4): FeatureCard(), HeroCarScene, Home(), useReveal()
...
Cohesion: 0.09
Nodes (27): App(), AdminLayout(), Dashboard(), DeliveriesManagement(), DeliveryTransaction, JapanBankAccount(), ContactsManagement(), OnboardingGuard() (+19 more)

### Community 89 - "J"
Cohesion: 0.07
Nodes (29): PREDEFINED_PERMISSIONS, UserManagement(), PLAN_DETAILS, SaasCompanySubscription, SaasControlCenter(), STORE_TYPE_CONFIG, iconMap, Props (+21 more)
...
Cohesion: 0.18
Nodes (11): clsx, @codetrix-studio/capacitor-google-auth, leaflet, lucide-react, dependencies, clsx, @codetrix-studio/capacitor-google-auth, leaflet (+3 more)
...
## Knowledge Gaps
- **703 isolated node(s):** `build-apk.sh script`, `ANDROID_HOME`, `PATH`, `build-store-apk.sh script`, `ANDROID_HOME` (+698 more)
...
- **Why does `dependencies` connect `dependencies` to `react-dom`, `react-is`, `react-leaflet`, `@react-three/fiber`, `shadcn`, `@tanstack/react-query`, `three`, `.copy`, `@supabase/supabase-js`, `Wt`, `Catalog-Dz-L_iSM.js`, `.clone`, `l`, `l`, `.setAttribute`, `.toString`, `Ye`, `index-BjaIWHBv.js`, `ln`, `.applyMatrix4`, `B`, `xn`, `Catalog-Dz-L_iSM.js`, `@base-ui/react`, `NotificationCenter.tsx`, `@capacitor/core`, `@base-ui/react`, `jsbarcode`, `package.json`, `qrcode`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `qrcode` connect `qrcode` to `dependencies`, `t`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `LabelCard()` connect `t` to `qrcode`, `J`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._

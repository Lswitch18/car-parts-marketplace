...
import Home from '@/modules/parts-catalog/pages/Home'
...
import MobileApp from '@/modules/logistics/pages/mobile/MobileApp'
import WorkerApp from '@/modules/logistics/pages/mobile/WorkerApp'
import QRInstallPage from '@/modules/logistics/pages/mobile/QRInstallPage'
import AgenciaPage from '@/modules/logistics/pages/mobile/AgenciaPage'
import MotionFramePage from '@/modules/parts-catalog/pages/MotionFramePage'
import ImmersiveExperience from '@/modules/parts-catalog/pages/ImmersiveExperience'
